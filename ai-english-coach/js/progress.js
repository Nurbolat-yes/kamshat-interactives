...
const Progress = {
    ...
    renderProgress() {
        ...
        const smartShoppingResult = data.smartShoppingResult;
                    ...
                    <div class="card" style="margin-bottom: 24px;">
                        ...
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap: 16px; margin-top: 12px;">
                            ...
                            <div>
                                ...
                                <div style="font-size: 0.8rem; color: var(--text-muted);">Functional Literacy</div>
                            </div>
                            <div>
                                <div style="font-size: 1.2rem; font-weight: 800; color: var(--accent-orange);">${smartShoppingResult.after.grammar}%</div>
                                <div style="font-size: 0.8rem; color: var(--text-muted);">Grammar</div>
                            </div>
                        </div>
