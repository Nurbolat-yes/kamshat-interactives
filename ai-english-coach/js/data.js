        ...
        },
        {
            ...
            lessons: [
                ...
                },
                {
                    ...
                    description: "Use functional literacy skills to compare offers, calculate total cost, and make a smart choice.",
                    content: {
                        challenge: {
                            title: "Smart Shopping Challenge",
                            level: "Unit 2 PISA Challenge",
                            scenario: "Your family has 9,000 tenge to spend this week. You need to buy school supplies and a snack, but you also want to save money and compare offers carefully.",
                            budget: 9000,
                            products: [
                                { name: "School backpack", price: 4200, note: "Strong and durable" },
                                { name: "Notebook pack", price: 1500, note: "3 notepads + 2 pens" },
                                { name: "Water bottle", price: 700, note: "Reusable bottle" },
                                { name: "Snack box", price: 1200, note: "Healthy snacks" },
                                { name: "Phone charger", price: 2800, note: "Fast charging" },
                                { name: "Sports bottle", price: 950, note: "10% discount on 2 or more items" }
                            ],
                            tasks: [
                                {
                                    type: "mcq",
                                    question: "Which piece of information is most important before choosing the best shopping option?",
                                    options: [
                                        "The color of the package",
                                        "The price, quantity, and total budget",
                                        "The seller's favorite product",
                                        "The number of people in the store"
                                    ],
                                    correct: 1,
                                    explanation: "Smart shopping starts with comparing price, quantity, and what you can afford within your budget."
                                },
                                {
                                    type: "fill",
                                    question: "If a backpack costs 4,200 tenge and a notebook pack costs 1,500 tenge, the total for both items is ___ tenge.",
                                    correct: "5700",
                                    explanation: "4,200 + 1,500 = 5,700. That's the correct total before adding other items."
                                },
                                {
                                    type: "mcq",
                                    question: "Which option is the best value if you need a drink and a snack for school?",
                                    options: [
                                        "Water bottle 700 + snack box 1,200 = 1,900",
                                        "Sports bottle 950 + snack box 1,200 = 2,150",
                                        "Water bottle 700 + notebook pack 1,500 = 2,200",
                                        "Charger 2,800 + notebook pack 1,500 = 4,300"
                                    ],
                                    correct: 0,
                                    explanation: "The water bottle and snack box give the best simple value for daily use while staying under budget."
                                },
                                {
                                    type: "text",
                                    question: "Write 2-3 sentences explaining which items you would buy and why. Use at least one sentence with 'I have decided...' or 'I would choose...' and mention your budget.",
                                    correct: "open",
                                    explanation: "A strong answer explains the choice, compares price, and connects it to the budget and real need."
                                }
                            ]
                        }
                    }
