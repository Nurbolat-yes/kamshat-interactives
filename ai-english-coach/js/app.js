...
const App = {
    ...
    renderDashboard() {
        ...
        const smartShoppingResult = Storage.getSmartShoppingResult();
        ...
        container.innerHTML = `
            <div>
                ...
                ${smartShoppingResult ? `
                    <div class="card" style="margin-bottom: 24px;">
                        <div class="card-header">
                            <span class="card-title">Smart Shopping Challenge</span>
                            <span class="card-subtitle">Completed</span>
                        </div>
                        <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap: 12px; margin-top: 12px;">
                            <div>
                                <div style="font-size: 1.2rem; font-weight: 800; color: var(--primary);">${smartShoppingResult.after.overall}%</div>
                                <div style="font-size: 0.75rem; color: var(--text-muted);">Overall</div>
                            </div>
                            <div>
                                <div style="font-size: 1.2rem; font-weight: 800; color: var(--accent-green);">${smartShoppingResult.after.functionalLiteracy}%</div>
                                <div style="font-size: 0.75rem; color: var(--text-muted);">Functional Literacy</div>
                            </div>
                            <div>
                                <div style="font-size: 1.2rem; font-weight: 800; color: var(--accent-orange);">${smartShoppingResult.after.grammar}%</div>
                                <div style="font-size: 0.75rem; color: var(--text-muted);">Grammar</div>
                            </div>
                        </div>
                    </div>
                ` : ''}
        ...
        container.innerHTML = `
            ...
            ${smartShoppingResult ? `
                <div class="card" style="margin-bottom: 24px;">
                    <div class="card-header">
                        <span class="card-title">SMART SHOPPING CHALLENGE</span>
                        <span class="card-subtitle">${smartShoppingResult.level}</span>
                    </div>
                    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(120px, 1fr)); gap: 12px; margin-top: 12px;">
                        <div>
                            <div style="font-size: 1.2rem; font-weight: 800; color: var(--primary);">${smartShoppingResult.after.overall}%</div>
                    ...
                    <p style="margin-top: 12px; color: var(--text-secondary);">${smartShoppingResult.summary}</p>
                </div>
            ` : ''}
